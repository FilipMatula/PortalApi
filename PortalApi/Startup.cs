    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PortalContext>(options =>
                options.UseSqlServer(_configuration.GetConnectionString("someeDBConnectionString")));
            services.AddScoped<IPortalRepository, PortalRepository>();
            services.AddScoped<IUserService, UserService>();
            services.AddTransient<IResourceValidator, ResourceValidator>();
            services.AddTransient<IMailService, MailService>();

            services.AddHangfire(x => x.UseSqlServerStorage(_configuration.GetConnectionString("someeDBConnectionString")));
